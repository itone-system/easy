  ...
  async listarForms (request, res) {
    try {
      ...
      return renderView('home/Movimentacao/Formularios/indexFormularios', {
        ...
        permissoesAlter: user.permissoes.ALTERACAO_CADASTRAL === undefined ? '' : user.permissoes.ALTERACAO_CADASTRAL.RETORNAR,
        permissoesRescisao: user.permissoes.RESCISAO === undefined ? '' : user.permissoes.RESCISAO.RETORNAR,
        permissoesFerias: user.permissoes.FERIAS === undefined ? '' : user.permissoes.FERIAS.RETORNAR,
