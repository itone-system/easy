module.exports = ({ link, codigoSolicitacao, cargo, unidade, departamento }) => {
          ...
          <table align="center" border="0" cellpadding="0" cellspacing="0" width="600">
            <tr>
              <td bgcolor="#ffffff" style="padding: 30px; color: #313131;">
                ...
                <p style="font-size: 16px; line-height: 1.5em; margin: 0 0 10px 0;">Easy informa que sua abertura de vaga abaixo está aprovada:</p>
