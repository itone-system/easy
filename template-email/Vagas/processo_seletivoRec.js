module.exports = ({ link, codigoSolicitacao, cargo, unidade, departamento, gestorImediato, motivo }) => {
          ...
          <table align="center" border="0" cellpadding="0" cellspacing="0" width="600">
            <tr>
              <td bgcolor="#ffffff" style="padding: 30px; color: #313131;">
                <h1 style="font-size: 24px; font-weight: bold; margin: 0 0 20px 0;">Recomeço de Processo Seletivo</h1>
                <p style="font-size: 16px; line-height: 1.5em; margin: 0 0 10px 0;">EASY informa que a vaga abaixo está apta para o processo seletivo novamente:</p>
